...
def insertar_medicamento(dni, droga, nombre, gramaje_mg, dosis, motivo, fecha_inicio, fecha_fin, conn=None):
    id_paciente = int(get_id_paciente_por_dni(dni, conn))
    query = """
        INSERT INTO medicamentos (id_paciente, droga, nombre, gramaje_mg, dosis, motivo, fecha_inicio, fecha_fin)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s)
    """
    params = (id_paciente, droga, nombre, gramaje_mg, dosis, motivo, fecha_inicio, fecha_fin)
